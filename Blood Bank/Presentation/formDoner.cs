...
{
    public partial class formDoner : Form
    {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            formDonerUpdate donerUpdate = new formDonerUpdate(Convert.ToInt32(dataGridViewShowDonar.SelectedRows[0].Cells["ColId"].Value));
        ...
        {
            formDonerAdd donarAdd = new formDonerAdd();
            donarAdd.ShowDialog();
            buttonSearch.PerformClick();
        }
    }
